...
function DialogHeader({ className, ...props }: React.ComponentProps<"div">) {
  return <div className={cn("gap-1 flex flex-col", className)} data-slot="dialog-header" {...props} />;
}
...
function DialogFooter({
  ...
  return (
    <div className={cn("gap-2 flex flex-col-reverse gap-2 sm:flex-row sm:justify-end", className)} data-slot="dialog-footer" {...props}>
      {children}
