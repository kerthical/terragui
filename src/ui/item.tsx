...
function ItemHeader({ className, ...props }: React.ComponentProps<"div">) {
  return <div className={cn("gap-2 flex basis-full items-center justify-between", className)} data-slot="item-header" {...props} />;
}

function ItemFooter({ className, ...props }: React.ComponentProps<"div">) {
  return <div className={cn("gap-2 flex basis-full items-center justify-between", className)} data-slot="item-footer" {...props} />;
}
