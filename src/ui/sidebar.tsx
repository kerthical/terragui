...
type SidebarMenuButtonRenderProps = React.HTMLAttributes<HTMLButtonElement> & {
...
function SidebarInput({ className, ...props }: React.ComponentProps<typeof Input>) {
  return <Input className={cn("bg-muted/20 dark:bg-muted/30 border-input h-8 w-full", className)} data-sidebar="input" data-slot="sidebar-input" {...props} />;
}

function SidebarHeader({ className, ...props }: React.ComponentProps<"div">) {
  return <div className={cn("gap-2 p-2 flex flex-col", className)} data-sidebar="header" data-slot="sidebar-header" {...props} />;
}

function SidebarFooter({ className, ...props }: React.ComponentProps<"div">) {
  return <div className={cn("gap-2 p-2 flex flex-col", className)} data-sidebar="footer" data-slot="sidebar-footer" {...props} />;
}
...
function SidebarGroup({ className, ...props }: React.ComponentProps<"div">) {
  return <div className={cn("px-2 py-1 relative flex w-full min-w-0 flex-col", className)} data-sidebar="group" data-slot="sidebar-group" {...props} />;
}
...
function SidebarGroupContent({ className, ...props }: React.ComponentProps<"div">) {
  return <div className={cn("text-xs w-full", className)} data-sidebar="group-content" data-slot="sidebar-group-content" {...props} />;
}

function SidebarMenu({ className, ...props }: React.ComponentProps<"ul">) {
  return <ul className={cn("gap-px flex w-full min-w-0 flex-col", className)} data-sidebar="menu" data-slot="sidebar-menu" {...props} />;
}
...
function SidebarMenuButton({
  ...
  const renderProp = tooltip
    ? (triggerProps: SidebarMenuButtonRenderProps) => {
        const { className: triggerClassName, style, ...rest } = triggerProps;
        const styleProps = style === undefined ? {} : { style };
        const classNameProps = triggerClassName === undefined ? {} : { className: triggerClassName };
        return <TooltipTrigger {...classNameProps} {...styleProps} {...rest} />;
      }
    : render;
  const renderProps = renderProp ? { render: renderProp } : {};
...
function SidebarMenuSkeleton({
  ...
  return (
    <div className={cn("h-8 gap-2 rounded-md px-2 flex items-center", className)} data-sidebar="menu-skeleton" data-slot="sidebar-menu-skeleton" {...props}>
