...
function Menubar({ className, ...props }: MenubarPrimitive.Props) {
  return <MenubarPrimitive className={cn("bg-background h-9 rounded-md border p-1 flex items-center", className)} data-slot="menubar" {...props} />;
}
...
function MenubarSeparator({ className, ...props }: React.ComponentProps<typeof DropdownMenuSeparator>) {
  return <DropdownMenuSeparator className={cn("bg-border/50 -mx-1 my-1 h-px -mx-1 my-1 h-px", className)} data-slot="menubar-separator" {...props} />;
}
