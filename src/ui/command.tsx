...
function CommandEmpty({ className, ...props }: React.ComponentProps<typeof CommandPrimitive.Empty>) {
  return <CommandPrimitive.Empty className={cn("py-6 text-center text-xs/relaxed", className)} data-slot="command-empty" {...props} />;
}
...
function CommandSeparator({ className, ...props }: React.ComponentProps<typeof CommandPrimitive.Separator>) {
  return <CommandPrimitive.Separator className={cn("bg-border/50 -mx-1 my-1 h-px", className)} data-slot="command-separator" {...props} />;
}
