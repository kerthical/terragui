...
#show: kindai-theme.with(
  config-info(
    title: [ノードベース UI を用いた宣言的クラウド構成の\ 視覚的編集・管理手法に関する研究],
    author: [近畿大学\ ネットワーク研究室\ 平田 麟太朗],
    event: [情報処理学会第88回全国大会\ 2026年3月6日（金）\ 12:40 \~ 15:10 \@ 松山大学 文京キャンパス L会場],
  ),
)
...
#align(center)[
  ...
  #table(
    ...
    [InfraMap], [○], [×], [×], [編集未対応], [○], [○],
    [Brainboard], [○], [○], [○], [×], [△（一部無償）], [×],
    [#text(fill: rgb("#c62828"), weight: "bold")[TerraGUI]],
